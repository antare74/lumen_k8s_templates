                ...
                <div class="content">
                    <table>
                        <tr>
                            ...
                            <td align="right"><h6 class="collapse">{{ array_key_exists('title', $mailData) ? $mailData['title'] : 'INFORMATION' }}</h6></td>
                        </tr>
                    </table>
                </div>
            </td>
